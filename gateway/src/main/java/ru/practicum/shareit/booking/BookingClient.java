...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> findAllBookingsByUser(Long userId, String state, Integer from, Integer size) {
    ...
    public ResponseEntity<Object> findAllBookingsByOwnerItems(Long userId, String state, Integer from, Integer size) {
        Map<String, Object> parameters = Map.of(
                "state", state,
                "from", from,
                "size", size
